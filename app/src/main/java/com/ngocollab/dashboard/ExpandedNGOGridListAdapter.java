...
public class ExpandedNGOGridListAdapter extends RecyclerView.Adapter<ExpandedNGOGridListAdapter.MyViewHolder> {
    ...
    public ExpandedNGOGridListAdapter(List<String> horizontalList, NgoListClickListener listener) {
